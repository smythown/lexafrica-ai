        ...
        <div style={{ width: "100%", maxWidth: "800px", background: "var(--card-bg)", border: `1px solid var(--card-border)`, borderRadius: "1.5rem", padding: "clamp(1.5rem, 4vw, 3rem)", boxShadow: darkMode ? "0 20px 60px rgba(0,0,0,0.5)" : "0 20px 60px rgba(0,0,0,0.1)" }}>
          ...
          {result && (
            <div style={{ marginTop: "2rem" }}>
              <div style={{ background: "linear-gradient(135deg, #16213e, #0f3460)", border: "1px solid #e94560", borderRadius: "1rem", padding: "1.5rem", marginBottom: "1.5rem", display: "flex", justifyContent: "space-between", alignItems: "center", flexWrap: "wrap", gap: "1rem" }}>
                <div>
                ...
                {(["advice","rights","letter","sources"] as const).map(t => (
                  <button key={t} onClick={() => setTab(t)}
                    style={{ 
                      ...
                      border: `1px solid ${tab === t ? "#e94560" : "#2d3748"}`, 
                      background: tab === t ? "#e94560" : "#0f0f1a", 
                      ...
                      result.sources.map((source, i) => (
                        <div key={i} style={{ marginBottom: "1.5rem", padding: "1.5rem", background: "#16213e", borderRadius: "0.75rem", border: "1px solid #2d3748" }}>
                          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "start", marginBottom: "0.75rem", flexWrap: "wrap", gap: "0.5rem" }}>
                            ...
                            <span style={{ fontSize: "0.75rem", color: "#10b981", background: "#0f3460", padding: "0.25rem 0.75rem", borderRadius: "999px", border: "1px solid #10b981", whiteSpace: "nowrap" }}>
                              🌐 Live Web Source
                            </span>
                          </div>
